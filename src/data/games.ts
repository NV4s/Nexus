...
const META: Record<string, Partial<Game>> = {
  ...
  'champion-archer': { thumb: '/thumbs/champion-archer.png' },
  'doodle-champion-island': { thumb: '/thumbs/doodle-champion-island.png' },
  'choose-your-weapon': { thumb: '/thumbs/choose-your-weapon.png' },
  'choose-your-weapon-2': { thumb: '/thumbs/choose-your-weapon-2.png' },
  'choose-your-weapon-3': { thumb: '/thumbs/choose-your-weapon-3.png' },
  'choose-your-weapon-4': { thumb: '/thumbs/choose-your-weapon-4.png' },
  'choose-your-weapon-5': { thumb: '/thumbs/choose-your-weapon-5.png' },
  'choose-your-weapon-tower-defense': { thumb: '/thumbs/choose-your-weapon-tower-defense.png' },
...
const EXTRA: Game[] = [
  ...
  },
  {
    ...
    section: 'arcade',
    runtime: 'html5',
    src: '/football-bros/index.html',
    category: 'Sports',
    thumb: '/thumbs/football-bros.png',
  ...
  },
  {
    ...
    section: 'arcade',
    runtime: 'html5',
    src: '/gta-simulator/index.html',
    category: 'Simulation',
    thumb: '/thumbs/gta-simulator.png',
